//
//  AgencyFormTenEnglishViewController.swift
...
class AgencyFormTenEnglishViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onSubmit(_ sender: Any) {
      let screenshot = self.view.takeScreenshotSeven()
                   ...
                   @objc func image(_ image: UIImage, didFinishSavingWithError error: Error?, contextInfo: UnsafeRawPointer) {           if let error = error {
                       ...
                       extension UIView {
                               func takeScreenshotEight() -> UIImage {
