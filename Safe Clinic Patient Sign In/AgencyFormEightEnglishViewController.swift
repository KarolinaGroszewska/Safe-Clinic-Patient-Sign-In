//
//  AgencyFormEightEnglishViewController.swift
...
class AgencyFormEightEnglishViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onSubmit(_ sender: Any) {
        let screenshot = self.view.takeScreenshotTwelve()
                   ...
                   @objc func image(_ image: UIImage, didFinishSavingWithError error: Error?, contextInfo: UnsafeRawPointer) {           if let error = error {
                       ...
                       extension UIView {
                               func takeScreenshotTwelve() -> UIImage {
