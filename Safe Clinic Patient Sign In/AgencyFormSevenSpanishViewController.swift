//
//  AgencyFormSevenSpanishViewController.swift
...
class AgencyFormSevenSpanishViewController: UIViewController {
    ...
    @IBAction func onSubmit(_ sender: Any) {
              let screenshot = self.view.takeScreenshotTwentySix()
                    ...
                    @objc func image(_ image: UIImage, didFinishSavingWithError error: Error?, contextInfo: UnsafeRawPointer) {           if let error = error {
                        ...
                        extension UIView {
                                func takeScreenshotTwentySix() -> UIImage {
