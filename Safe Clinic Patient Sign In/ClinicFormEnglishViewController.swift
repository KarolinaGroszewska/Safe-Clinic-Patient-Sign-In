...
class ClinicFormEnglishViewController: UIViewController, MFMailComposeViewControllerDelegate, UITextFieldDelegate, UITextViewDelegate {
    ...
    @IBAction func onSubmit(_ sender: Any) {
        ...
        let screenshot = self.view.takeScreenshotTwo()
...
extension UIView {
    func takeScreenshotTwo() -> UIImage {  UIGraphicsBeginImageContextWithOptions(self.bounds.size, false, UIScreen.main.scale)
