...
class AgencyChildFormSpanishViewController: UIViewController, UITextFieldDelegate {
        ...
        scrollView.frame = CGRect(x: 0, y: 0, width: scrollView.frame.width, height: scrollView.frame.height)
               ...
               scrollView.addSubview(imageView)
                ...
                let birthdayField:UITextField = {
                    let textField = UITextField(frame: CGRect(x: 532, y:145, width: 180, height: 20))
                    textField.translatesAutoresizingMaskIntoConstraints = false
                ...
                let ageField:UITextField = {
                    let textField = UITextField(frame: CGRect(x: 350, y:150, width: 35, height: 20))
                    textField.translatesAutoresizingMaskIntoConstraints = false
            ...
            scrollView.addSubview(prefField)
            scrollView.bringSubviewToFront(prefField)
    ...
    @IBAction func onSubmit(_ sender: Any) {
        ...
        //                                                                 "Date": Date])
          ...
          let screenshot = self.view.takeScreenshotTwentyThree()
            ...
            @objc func image(_ image: UIImage, didFinishSavingWithError error: Error?, contextInfo: UnsafeRawPointer) {           if let error = error {
                ...
                extension UIView {
                        func takeScreenshotTwentyThree() -> UIImage {
