//
//  ClinicFormSpanishViewController.swift
...
class ClinicFormSpanishViewController: UIViewController, UIScrollViewDelegate, UITextFieldDelegate {
    ...
    @IBAction func onSubmit(_ sender: Any) {
        ...
        self.ref.child("ClinicPatients").childByAutoId().setValue(["Date": dict["Date"],
                  ...
                  let screenshot = self.view.takeScreenshotSeventeen()
                    ...
                    @objc func image(_ image: UIImage, didFinishSavingWithError error: Error?, contextInfo: UnsafeRawPointer) {           if let error = error {
                        ...
                        extension UIView {
                                func takeScreenshotSeventeen() -> UIImage {
